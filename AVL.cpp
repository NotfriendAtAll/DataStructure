...
// 平衡因子
template <class T>
bool BSTtree<T>::Balance_Factors(TreeNode<T> *root)
{
...
template <class T>
int BSTtree<T>::GetHeight(TreeNode<T> *&root)
{
    if (root == nullptr)
    {
        return 0;
...
template <class T>
void BSTtree<T>::SetHegiht(TreeNode<T> *&root)
{
...
template <class T>
void BSTtree<T>::rrRotation(TreeNode<T> **root)
{
...
template <class T>
void BSTtree<T>::llRotation(TreeNode<T> **root)
{
...
template <class T>
void BSTtree<T>::Insert(TreeNode<T> *&root, const T &val)
{
    if (root == nullptr)
    {
...
template <class T>
void BSTtree<T>::Preorder(TreeNode<T> *root)
{
    if (root == nullptr)
    {
        return;
...
template <class T>
void BSTtree<T>::Inorder(TreeNode<T> *root)
{
    if (root == nullptr)
    {
        return;
...
template <class T>
void BSTtree<T>::Postorder(TreeNode<T> *root)
{
    if (root == nullptr)
    {
        return;
...
template <class T>
void BSTtree<T>::ExitTarget(TreeNode<T> *root, T target)
{
